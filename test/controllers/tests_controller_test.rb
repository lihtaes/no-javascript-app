...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { body: @test.body, nickname: @test.nickname, title: @test.title } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { body: @test.body, nickname: @test.nickname, title: @test.title } }
